...
public class MoreMethods {
	...
	//create method that should return the largest number from an array
	...
	//create method that will accept a String and return words from that string
	//Hello Word, Good night friends
